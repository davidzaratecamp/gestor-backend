-- Migración 015: Agregar rol gestorActivos y tabla de activos (CORREGIDA)
-- Fecha: 2025-01-XX

-- 1. Actualizar el ENUM de roles para incluir gestorActivos (usando la estructura actual)
...
CREATE INDEX IF NOT EXISTS idx_activos_numero_placa ON activos(numero_placa);
CREATE INDEX IF NOT EXISTS idx_activos_ubicacion ON activos(ubicacion);
CREATE INDEX IF NOT EXISTS idx_activos_responsable ON activos(responsable);
CREATE INDEX IF NOT EXISTS idx_activos_created_at ON activos(created_at);
